...
public class DbsnpSubmittedVariantEntity extends AccessionedDocument<ISubmittedVariant, Long> implements ISubmittedVariant {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbsnpSubmittedVariantEntity)) {
            return false;
        }

        DbsnpSubmittedVariantEntity that = (DbsnpSubmittedVariantEntity) o;
